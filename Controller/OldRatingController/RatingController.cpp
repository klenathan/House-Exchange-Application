...
//// */
////void OldRatingController::rating(Request request) {
...
////}
////
////vector<User> OldRatingController::ratingAverage(vector<User> &userArray) {
...
////}
////
////vector<House> OldRatingController::ratingAverage(vector<House> &houseArray) {
